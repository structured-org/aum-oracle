...
// Source: ./../../oracle/jupiter/interface.go
...
// GetJupiterAumContractNextRound mocks base method.
func (m *MockNeutronAumContractClient) GetJupiterAumContractNextRound(ctx context.Context) (*neutron.NextRound, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetJupiterAumContractNextRound", ctx)
	ret0, _ := ret[0].(*neutron.NextRound)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetJupiterAumContractNextRound indicates an expected call of GetJupiterAumContractNextRound.
func (mr *MockNeutronAumContractClientMockRecorder) GetJupiterAumContractNextRound(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetJupiterAumContractNextRound", reflect.TypeOf((*MockNeutronAumContractClient)(nil).GetJupiterAumContractNextRound), ctx)
}

// SubmitJupiterAumData mocks base method.
func (m *MockNeutronAumContractClient) SubmitJupiterAumData(ctx context.Context, data *neutron.JupiterAumData) (*neutron.NextRound, error) {
	m.ctrl.T.Helper()
...
func (mr *MockNeutronAumContractClientMockRecorder) SubmitJupiterAumData(ctx, data interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SubmitJupiterAumData", reflect.TypeOf((*MockNeutronAumContractClient)(nil).SubmitJupiterAumData), ctx, data)
}
