...
contract MockBinanceAumDeploy is Script {
  function run() external {
    ...
    positions[0] = Position({symbol: 'BNBUSDT', amount: -200, pnl: 286824336151});
    positions[1] = Position({symbol: 'BTCUSDT', amount: 56946, pnl: -209564864061083});
    positions[2] = Position({symbol: 'ETHUSDT', amount: -217162, pnl: 8557557504747});
    positions[3] = Position({symbol: 'SOLUSDT', amount: -2462759, pnl: 71765658623684});
    ...
    spotBalances[2] = SpotBalance({asset: 'ETH', amount: 0});
    spotBalances[3] = SpotBalance({asset: 'SOL', amount: 2000});
    ...
    vm.startBroadcast(pk);
    mockBinanceAum.setData(9352, 1766078280, binanceData);
    vm.stopBroadcast();
  }
}
