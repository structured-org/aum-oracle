module github.com/structured-org/aum-oracle/recorder
...
require (
	...
	github.com/structured-org/aum-messenger/pkg/client v0.0.0
...
replace (
	...
	github.com/structured-org/aum-messenger/pkg/client => ../pkg/client
)
